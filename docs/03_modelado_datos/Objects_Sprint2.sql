...
BEGIN
    ...
    IF v_idPersona IS NULL THEN
        ...
        VALUES (p_dni, p_nombre1, p_nombre2, p_apellido1, p_apellido2, p_fecha_nacimiento, p_telefono, p_direccion, p_correo);
        SET v_idPersona = LAST_INSERT_ID();
    ELSE
        UPDATE personas 
        SET nombre1 = p_nombre1, nombre2 = p_nombre2, apellido1 = p_apellido1, apellido2 = p_apellido2, 
            telefono = p_telefono, direccion = p_direccion, correo = p_correo, fecha_nacimiento = p_fecha_nacimiento 
...
BEGIN
    ...
    UPDATE personas 
    SET nombre1 = p_nombre1, nombre2 = p_nombre2, apellido1 = p_apellido1, apellido2 = p_apellido2, 
        fecha_nacimiento = p_fecha_nacimiento, telefono = p_telefono, direccion = p_direccion, correo = p_correo
...
CREATE OR REPLACE VIEW vw_detalle_colaboradores AS
SELECT 
    c.idColaborador, p.idPersona, p.dni_ce, p.nombre1, p.nombre2, p.apellido1, p.apellido2, 
    p.fecha_nacimiento, p.telefono, p.direccion, p.correo,
